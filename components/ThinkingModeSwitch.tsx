...
const mainModes: { id: SearchMode | Page | string; label: string; icon: React.ReactElement, isAction?: boolean }[] = [
  ...
  },
  {
    id: 'build-logs',
    label: 'سجلات البناء',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M2 4a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1zM2 9a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1zM2 14a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1z" /></svg>
  },
   {
...
const ThinkingModeSwitch: React.FC<ThinkingModeSwitchProps> = ({ mode, onModeChange, isLoading, onNavigate, onAction }) => {
    ...
    const navigationPages: Page[] = ['speedtest', 'live', 'tts', 'business', 'aigen6', 'projectspace', 'cr', 'spreadsheet', 'word-processor', 'presentation-builder', 'webapp-builder', 'build-logs'];
